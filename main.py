# -*- coding: utf-8 -*-
"""
Created on Tue Dec 20 17:06:12 2022
...
from production import E, R, H, fT, x, fS, fL, fCO2, objective_z, cons1, stock_balance

if __name__ == '__main__':

   
    data11 = pd.read_excel('BJ-11.xlsx')
    data12 = pd.read_excel('BJ-12.xlsx')
